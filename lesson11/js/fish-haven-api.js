...
const weatherapiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&APPID=3d24da718e3087a672a2f05aa9ca642c";
...
const forecastapiURL = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&APPID=3d24da718e3087a672a2f05aa9ca642c";
...
fetch(requestURL)
    ...
    .then(function (jsonObject) {
        ...
        towns.filter(town => (town.name == 'Fish Haven')).forEach(town => {
            ...
            townEvents.innerHTML = `${town.events[0]}<br>${town.events[1]}<br>${town.events[2]}<br>${town.events[3]}`;
